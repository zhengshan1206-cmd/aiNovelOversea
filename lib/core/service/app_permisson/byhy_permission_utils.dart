...
class ByPermissionUtils {
  ...
  static Future<bool> _requestPermission(
    ...
    if(Platform.isAndroid){
      ...
      if (status.isDenied) {
        ...
        //   builder: (context) {
        //     return PermissionsUsageDialog(
        //         permissionBeans: permission.permissionUsageBean);
        //   },
        // );
  ...
  static Future<void> openPermissionSettings() async {
    ...
    if (Platform.isIOS) {
      ...
      url = Uri.parse('android.settings.APPLICATION_DETAILS_SETTINGS?package=$packageName');
    }
