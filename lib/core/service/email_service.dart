 ...
 * @LastEditTime: 2025-12-04 21:31:12
 * @FilePath: /novel_oversea/lib/core/service/email_service.dart
 * @Description: 
 */
...
class EmailService {
  ...
  static String _buildEmailUrl({
    ...
    if (queryParams.isNotEmpty) {
      ...
      query = queryParams.entries.map((e) {
  ...
  static Future<void> launchEmail({Function? failed}) async {
    try {
      ...
      try {
        ...
        failed?.call();
        throw Exception("Unable to open email app, please check if an email client is installed. Error: $e");
      }
      failed?.call();
    } catch (e) {
