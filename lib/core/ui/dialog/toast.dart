 ...
 * @LastEditTime: 2026-02-05 14:02:18
 * @FilePath: /novel_oversea/lib/core/ui/dialog/toast.dart
 * @Description: 
 */
...
class Toast{
  ...
  static void showText({
    ...
    switch(type) {
      ...
      case ToastType.success:
        _showSuccess(align: align, action: action, text: text, clickText: clickText);
        break;
  ...
  /// 显示成功
  static void _showSuccess({String text = '', String? clickText, required Alignment align, Function()? action}) {
    _showToast(
      align: align,
      action: action,
  ...
  /// 显示失败
  static void _showError({String text = '', required Alignment align, Function()? action}) {
    _showToast(
      align: align,
      action: action,
      child: _showIconToast(
  ...
  /// 默认显示文字
  static void _showWarning({String text = '', required Alignment align, Function()? action}) {
    _showToast(
      align: align,
      action: action,
      child: _showIconToast(
  ...
  /// 通用调用
  static void _showToast({required Widget child, required Alignment align, Function()? action}) {
