...
class _MultiStatusViewState extends State<MultiStatusView>
  ...
  Widget _buildEmptyWidget() {
    List<Widget> content = widget.emptyWidget != null
        ...
        : [
            Image.asset(
              'assets/global/common/icon_content_empty.png', width: 200.w, height: 150.w),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: widget.noNetWorkWidget != null
                  ...
                  : [
                      ByText.text(text: "Network error, please try again later", fontSize: 16.sp, textColor: ByColor.colorF2),
                      SizedBox(
                        height: 20.w,
                      ),
                      Container(
  ...
  List _getActions(EmptyActionType emptyActionType) {
    switch (emptyActionType) {
      case EmptyActionType.all:
        return [
          ByText.text(text:  widget.emptyText ?? '暂无内容', fontSize:  16.sp,
