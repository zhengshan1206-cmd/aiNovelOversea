...
import 'package:novel_oversea/core/common/assets_data.dart';
import 'package:novel_oversea/core/common/byhy_colors.dart';
...
import 'package:novel_oversea/main.dart';
...
class ByWidgetsUtil {
          ...
          GestureDetector(
            ...
            onTap: () async {
              ...
              if (popScop) {
                ...
                final canPop = await ByDialogUtil.showPopScopeDialog(
                  context: context,
                  contents: contents,
                  title: popScopTitle,
  ...
  // static Widget fadedSpin({Color? color, double? size}) {
  //   return SpinKitFadingCircle(
  //     color: color ?? ByHyColorUtil.whiteColor,
  //     size: size ?? 30.w,
  //   );
  // }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: bgColor ?? ByHyColorUtil.loginBtnBgColor.withValues(alpha: 0.1),
  ...
  static GestureDetector gradientBtn({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius:
          csutomerBorderRadius ?? BorderRadius.circular(borderRadius ?? 8),
          gradient: gradient,
        ),
        child: Text(
          title,
  ...
  /// 通用富文本提示组件
  static Widget commonRichTextTipsBar({
