...
import 'package:novel_oversea/core/ui/view/byhy_base_web_view.dart';
...
class ByNavRouterUtils {
  ...
  /// 跳转Name
  static dynamic pushNamed(BuildContext context, String name, {Object? arguments}) {
    return Navigator.pushNamed(context, name, arguments: arguments);
  }

  /// 跳转Name
  static dynamic pushReplacementNamed(BuildContext context, String name,
      {Object? arguments}) {
  ...
  static dynamic pushReplacement(BuildContext context, Widget scene, {String? name}) {
  ...
  /// 跳到WebView页 - 带返回值
  /// 修复 Flutter 新版本 MaterialPageRoute 默认缩放动画导致的问题
  static dynamic jumpWebViewPageResult(BuildContext context, String title, String url) {
    return Navigator.push(
      context,
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) =>
