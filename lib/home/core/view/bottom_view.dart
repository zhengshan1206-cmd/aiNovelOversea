    ...
    return Row(
      children: [
        ...
        GestureDetector(
          ...
          child: ByText.text(
              text: 'earn', fontSize: 12.sp, textColor: Color(0XFF98FC4A)),
        ),
        SizedBox(
          width: 4.w,
        ),
  ...
  Widget _buildNormalBottomView() {
    ...
    return Container(
      ...
      padding: EdgeInsets.only(
        ...
        right: padding ?? 12.w,
        top: margin ?? 4.w,
        bottom: (isBottom! ? ByScreenUtils.bottomSafeHeight : 0) + (margin ?? 4.w),
      ),
      child: Stack(
          children: [
            SizedBox(
