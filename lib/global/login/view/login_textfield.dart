...
const double _hintTextFontSize = 16.0;
...
class _LoginTextFieldState extends State<LoginTextField> {
  ...
  Widget _body() {
    ...
    var labelTextStyle =
        const TextStyle(fontSize: _hintTextFontSize, color: Colors.orange);
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: widget.border ??
                  OutlineInputBorder(
                    // borderSide:
                    //     const BorderSide(color: Color(0xFFF3F3F5), width: 1.0),
                    borderRadius: BorderRadius.circular(12.w),
                  ),
              focusedBorder: widget.border ??
                  OutlineInputBorder(
                    borderSide: const BorderSide(
                        color: ByColor.colorC1, width: 1.0),
                    borderRadius: BorderRadius.circular(12.w),
                  ),
            ...
            onChanged: (value) {
              ...
              // _textController!.text = phone;
              widget.inputCallBack?.call(phone);
            },
            // 输入完成，提交按钮点击后会先执行这里
            onEditingComplete: () {
              _focusNode!.unfocus();
