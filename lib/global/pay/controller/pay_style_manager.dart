 ...
 * @LastEditTime: 2026-02-26 14:27:59
 * @FilePath: /novel_oversea/lib/global/pay/controller/pay_style_manager.dart
 * @Description: 
 */
...
class PayStyleManager {
  ...
  String getPrice(dynamic package, {bool isDiscount = false,}) {
    try {
      String price = isDiscount ? package.discountLocalPrice : package.localPrice;
      return price.isNotEmpty ? price : '\$${package.money}';
    }
    catch(e) {
