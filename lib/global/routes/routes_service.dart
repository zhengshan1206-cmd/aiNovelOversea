...
// /novel_outline_detail_page - 小说大纲详情页面
  ...
  static void reportPageView({
    ...
    final Map<String, dynamic> params = {
      ...
      'duration': duration,
      'page_path':
          prePagePath == '/pay_center_page' ? landingPage : prePagePath,
  ...
  static void _reportWithRetry(
      Map<String, dynamic> params, int retryCount, String type) {
    HttpUtils.post(
      APIs.eventReport,
      params,
  ...
  static String getActualMainPageRoute(String? routeName,
