...
import 'package:novel_oversea/global/routes/routes_service.dart';
...
class MyRouteObserver extends GetObserver with WidgetsBindingObserver {
      ...
      case AppLifecycleState.paused:
        ...
        if (_currentProviderPageId != null) {
          ...
          _reportProviderPageDuration(
              _currentProviderPageId!, _currentProviderPageId!);
        }
        break;
  ...
  void didPush(Route route, Route? previousRoute) {
    ...
    final String? actualCurrentRoute =
        _getActualMainPageRoute(currentRouteName);
    final String? actualPreviousRoute =
        _getActualMainPageRoute(previousRouteName);
  ...
  void _handleProviderPagePush(
      String providerPageId, String? previousRouteName) {
    // 上报上一个页面的停留时长
    if (_currentActivePage != null) {
  ...
  void _handleProviderPageReplace(
      String newProviderPageId, String? oldRouteName) {
  ...
  void _handleProviderPagePop(
      String currentProviderPageId, String? previousRouteName) {
