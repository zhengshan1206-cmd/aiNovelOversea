...
class SetupController extends GetxController {
  ...
  void onInit() {
    ...
    ///过滤显示的协议
    protocolList = GlobalController.instance.config.protocolList.where((e) => e.show).toList();
  }
